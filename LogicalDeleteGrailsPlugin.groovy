...
class LogicalDeleteGrailsPlugin {
    ...
    def title = "Logical Delete Plugin" // Headline display name of the plugin
    def author = "Ezequiel Parada"
    def authorEmail = "ezequiel@nan-labs.com"
    def description = '''\
Brief summary/description of the plugin.
'''

    // URL to the plugin's documentation
    def documentation = "http://grails.org/plugin/logic-delete"
